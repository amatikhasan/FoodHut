...
public class ScheduleAdapterProvider extends RecyclerView.Adapter<ScheduleAdapterProvider.ViewHolder> {
    private Context contex;
    private ArrayList<ScheduleProvider> data;

    public ScheduleAdapterProvider(Context contex, ArrayList<ScheduleProvider> data) {
        this.contex = contex;
        this.data = data;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final ScheduleProvider obj = data.get(position);
