    ...
    public void getAddress(double lati,double longi) {
        ...
        try {
           ...
           // HttpHelper helper=new HttpHelper();
            //String jsonString=helper.serviceCall(lati,longi);
           // JSONObject jsonObj=new JSONObject(jsonString);
            JSONObject jsonObj = JsonParser.getJSONfromURL("http://maps.googleapis.com/maps/api/geocode/json?latlng=" + lati + "," + longi + "&sensor=true");
