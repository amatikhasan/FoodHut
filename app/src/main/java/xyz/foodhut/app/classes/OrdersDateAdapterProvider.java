...
import xyz.foodhut.app.ui.provider.Orders;


public class OrdersDateAdapterProvider extends RecyclerView.Adapter<OrdersDateAdapterProvider.ViewHolder> {
    private Context contex;
    private ArrayList<String> data=new ArrayList<>();
    private String type;

    public OrdersDateAdapterProvider(Context contex, ArrayList<String> data,String type) {
        this.contex = contex;
        this.data = data;
        this.type=type;
    }
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(type.equals("provider")) {
                    Intent intent = new Intent(contex, Orders.class);
                    intent.putExtra("date", date);
                    contex.startActivity(intent);
                }
