...
public class ProfileCustomer extends AppCompatActivity {
                ...
                okButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!etName.getText().toString().isEmpty()) {
                            ...
                            Toast.makeText(ProfileCustomer.this, "Required fields are missing", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    public void updatePhoto() {
        ...
        if (filePath != null) {
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (imageURL[0] != null) {
                                ...
                                Toast.makeText(ProfileCustomer.this, "Something Wrong! Please try again", Toast.LENGTH_SHORT).show();
                            }
            ...
            Toast.makeText(ProfileCustomer.this, "No image selected", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void checkFilePermissions() {
        if (Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.M) {
            int permissionCheck = ProfileCustomer.this.checkSelfPermission("Manifest.permission.READ_EXTERNAL_STORAGE");
            permissionCheck += ProfileCustomer.this.checkSelfPermission("Manifest.permission.WRITE_EXTERNAL_STORAGE");
    ...
    public void getOrdinate() {
        if (ActivityCompat.checkSelfPermission(ProfileCustomer.this, ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

            return;
        }
        client.getLastLocation().addOnSuccessListener(ProfileCustomer.this, new OnSuccessListener<Location>() {
            @Override
    ...
    public void getAddress(double lat, double lng) {
        Geocoder geocoder = new Geocoder(ProfileCustomer.this, Locale.getDefault());
        try {
