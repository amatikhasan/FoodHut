...
public class ScheduleTab extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //      getSupportActionBar().setTitle("My ScheduleTab");
     //   }
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    ScheduleTab.this.finish();
                    // User is signed in
                    startActivity(new Intent(ScheduleTab.this, PhoneAuthRegister.class));
